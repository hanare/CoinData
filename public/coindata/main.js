...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _bitcoin_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bitcoin.service */ "./src/app/bitcoin.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(_bitcoinservice, _datepipe) {
        this._bitcoinservice = _bitcoinservice;
        this._datepipe = _datepipe;
        this.title = 'CoinData';
        this.startDate = new Date(2017, 7, 17);
    ...
    AppComponent.prototype.getHistoricalData = function (startDate, endDate) {
        var _this = this;
        var startdate = this._datepipe.transform(this.startDate, 'yyyy-MM-dd');
        var enddate = this._datepipe.transform(this.endDate, 'yyyy-MM-dd');
        console.log(startdate, " ---- ", enddate);
        this._bitcoinservice.getHistoricalBoundedBIP(startdate, enddate).subscribe(function (data) {
            _this.renderChart(data);
        });
    };
    AppComponent.prototype.displayChart = function (value, event) {
    ...
    AppComponent.prototype.renderChart = function (data) {
        var _this = this;
        var bpi_dates = new Array();
        var bpi_rates = new Array();
        // console.log("-----------------");
        var bpi = data.bpi;
        //console.log((bpi));
        Object.entries(bpi).forEach(function (_a) {
            var date = _a[0], rate = _a[1];
            // console.log(date," ---",rate);
            var bpi_date = _this._datepipe.transform(date, 'dd,MMM,yyyy');
        ...
        this.bpiChart = new chart_js__WEBPACK_IMPORTED_MODULE_3__["Chart"]('bpiCanvas', {
            type: 'line',
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_bitcoin_service__WEBPACK_IMPORTED_MODULE_2__["BitCoinService"],
...
/* harmony import */ var _bitcoin_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./bitcoin.service */ "./src/app/bitcoin.service.ts");
...
var BitCoinService = /** @class */ (function () {
    function BitCoinService(_http) {
        this._http = _http;
    }
    BitCoinService.prototype.getCurrentPrice = function () {
        var url = 'https://api.coindesk.com/v1/bpi/currentprice.json';
        return this._http.get(url);
    };
    BitCoinService.prototype.getHistoricalBIP = function () {
        var url = 'https://api.coindesk.com/v1/bpi/historical/close.json';
        return this._http.get(url);
    };
    BitCoinService.prototype.getHistoricalBoundedBIP = function (startDate, endDate) {
        var url = "https://api.coindesk.com/v1/bpi/historical/close.json?start=" + startDate + "&end=" + endDate;
        return this._http.get(url);
    };
    BitCoinService.prototype.getCurrencPrice = function (currency) {
